...
<div id="corps">
    ...
    <div id="header">
        ...
        <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" id="logo" class="logo">Pro Bono Lab</a>
        <div id="img">
        ...
        <div id="bloc-menu-principal">
			...
			<?php
                    ...
                    elseif($menu['href'] == 'http://pro-bono.fr')
                    {
                        print $menu['href'];
                    }
                    else
                    {
                        $lien = drupal_get_path_alias($menu['href']);
                        print $front_page.$lien;
                    }
                    ?>
			" class="<?php print strtolower($menu['title']); ?>"><?php print $menu['title']; ?></a></li>
    ...
    <!--CONTENT-->
    <div id="content">
        <?php if(!$is_front) print render($page['sidebar_first']); ?>
        <div id="contenu">
            <?php print $messages; ?>
